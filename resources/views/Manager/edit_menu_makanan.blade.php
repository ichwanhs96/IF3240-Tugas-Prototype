    ...
    <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
        <div class="panel panel-info" >
            <div class="panel-heading">
                <div class="panel-title">Edit Menu Makanan</div>
            </div>     
            ...
            <div style="padding-top:30px" class="panel-body" >
                ...
                {!! Form::open(['route' => 'manager.updateMenu', 'id' => 'loginform', 'class' => 'form-horizontal', 'role' => 'form']) !!}    
                    ...
                    <div style="margin-bottom: 25px" class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                        {!! Form::select('jenis', ['0' => 'Makanan', '1' => 'Minuman', '2' => 'Lain'], $menu->jenis, ['class' => 'form-control', 'required']) !!}
                    </div>

                    {!! Form::label('harga menu:') !!}
                    <div style="margin-bottom: 25px" class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                        {!! Form::text('harga', $menu->harga, ['class' => 'form-control', 'required']) !!}
                    </div>
